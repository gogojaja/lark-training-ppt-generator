...
### 15. quiz-extraction-skill

**技能名称**: 考试题抽取技能包
**技能版本**: v1.0.0
**发布日期**: 2026-08-18
**技能描述**: 从 Word/PPT/TXT/Markdown 源文档抽取考试题，AI 语义识别题型与题组，脚本做解析与规范化，输出 JSON/CSV/Markdown/PPTX 多格式题库
...
# 2. AI 语义抽取（按 SKILL.md Step 2 Prompt 模板）
# 3. 规范化 + 门禁 + 输出
...
### 出题考核
- **quiz-extraction-skill**: 考试题抽取 ✅ 新增
...
### v2.1.0 (2026-08-18)
- 新增 quiz-extraction-skill（考试题抽取）
- 新增「出题考核」技能分类
